export const homeFallback = {
  ...
  areaMap: {
    ...
    supportingLine: 'Every point below is a real walk from Nackagatan 4 — the map is live, the minutes are honest.',
    pois: [
      { _id: 'poi-balue', name: 'Balue', description: 'Coffee bar', category: 'coffee', walkingMinutes: 9, lat: 59.3168, lng: 18.0819, sortOrder: 1 },
      { _id: 'poi-sairu-sushi', name: 'Sairu Sushi', description: 'Sushi', category: 'lunch', walkingMinutes: 10, lat: 59.3175, lng: 18.0831, sortOrder: 2 },
      { _id: 'poi-stella', name: 'Stella Pizza Restaurant', description: 'Pizza', category: 'lunch', walkingMinutes: 4, lat: 59.3138, lng: 18.0742, sortOrder: 3, showRoute: true },
      { _id: 'poi-lulu', name: 'Lulu, Poke and Sushi Bar', description: 'Poke and sushi', category: 'lunch', walkingMinutes: 5, lat: 59.3142, lng: 18.0765, sortOrder: 4 },
      { _id: 'poi-taza', name: 'Taza Artisan Café', description: 'Coffee', category: 'coffee', walkingMinutes: 5, lat: 59.3130, lng: 18.0735, sortOrder: 5 },
      { _id: 'poi-kajsas-parken', name: 'Kajsas i Parken', description: 'Café in the park', category: 'lunch', walkingMinutes: 3, lat: 59.3129, lng: 18.0748, sortOrder: 6, showRoute: true },
      { _id: 'poi-kajsas-kajen', name: 'Kajsas på Kajen', description: 'Ice cream café', category: 'coffee', walkingMinutes: 6, lat: 59.3118, lng: 18.0762, sortOrder: 7 },
      { _id: 'poi-mormors', name: 'Mormors Restaurant and Dumplings', description: 'Dumplings', category: 'lunch', walkingMinutes: 8, lat: 59.3161, lng: 18.0798, sortOrder: 8 },
      { _id: 'poi-bleck', name: 'Restaurant Bleck', description: 'Restaurant', category: 'wine', walkingMinutes: 7, lat: 59.3151, lng: 18.0698, sortOrder: 9 },
      { _id: 'poi-restaurant-nytorget', name: 'Restaurant Nytorget', description: 'Restaurant', category: 'lunch', walkingMinutes: 9, lat: 59.3170, lng: 18.0822, sortOrder: 10 },
      { _id: 'poi-urban-deli', name: 'Urban Deli', description: 'Grocer and restaurant', category: 'lunch', walkingMinutes: 10, lat: 59.3173, lng: 18.0827, sortOrder: 11 },
      { _id: 'poi-bar-agrikultur', name: 'Bar Agrikultur', description: 'Wine bar', category: 'wine', walkingMinutes: 11, lat: 59.3178, lng: 18.0836, sortOrder: 12 },
      { _id: 'poi-meatballs', name: 'Meatballs for the People', description: 'Restaurant', category: 'lunch', walkingMinutes: 10, lat: 59.3176, lng: 18.0812, sortOrder: 13 },
      { _id: 'poi-cafe-nizza', name: 'Cafe Nizza', description: 'Coffee', category: 'coffee', walkingMinutes: 6, lat: 59.3133, lng: 18.0700, sortOrder: 14 },
      { _id: 'poi-rot-shop', name: 'Rot Shop & Kitchen', description: 'Restaurant', category: 'lunch', walkingMinutes: 8, lat: 59.3140, lng: 18.0680, sortOrder: 15 },
      { _id: 'poi-svedjan', name: 'Svedjan', description: 'Bakery', category: 'coffee', walkingMinutes: 8, lat: 59.3145, lng: 18.0685, sortOrder: 16 },
      { _id: 'poi-orion', name: 'Orion Theathre', description: 'Theatre', category: 'culture', walkingMinutes: 12, lat: 59.3122, lng: 18.0655, sortOrder: 17 },
      { _id: 'poi-stc-gym', name: 'STC Gym', description: 'Gym', category: 'gym', walkingMinutes: 5, lat: 59.3140, lng: 18.0725, sortOrder: 18 },
      { _id: 'poi-friskis', name: 'Friskis & Svettis', description: 'Gym', category: 'gym', walkingMinutes: 14, lat: 59.3105, lng: 18.0680, sortOrder: 19 },
      { _id: 'poi-thaiboat', name: 'Thaiboat', description: 'Restaurant', category: 'lunch', walkingMinutes: 22, lat: 59.3070, lng: 18.0980, sortOrder: 20 },
      { _id: 'poi-carnegie', name: 'Nya Carnegiebryggeriet', description: 'Brewery', category: 'wine', walkingMinutes: 25, lat: 59.3048, lng: 18.1050, sortOrder: 21 },
      { _id: 'poi-sjostadens', name: 'Sjöstadens Marina Restaurant', description: 'Restaurant', category: 'lunch', walkingMinutes: 26, lat: 59.3040, lng: 18.1070, sortOrder: 22 },
      { _id: 'poi-indian-street', name: 'Indian Street Food & Co', description: 'Restaurant', category: 'lunch', walkingMinutes: 23, lat: 59.3055, lng: 18.1010, sortOrder: 23 },
    ],
  },
  viewing: {
