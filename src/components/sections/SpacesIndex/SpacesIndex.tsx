...
//
// When viewport ≤ 1280 px the first term wins; when larger the second does.
// Result: the image always starts exactly at the right edge of the list column.

const MAX_W  = "80rem";   // max-w-7xl  = 1280px
...
export const SpacesIndex: React.FC<SpacesIndexSection> = ({
  ...
  const container = "max-w-7xl mx-auto w-full px-4 md:px-8";
